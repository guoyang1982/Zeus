...
import com.gy.sched.server.store.JobInstanceSnapshotAccess;
...
public class JobInstanceSnapshotAccess4Mysql implements
	...
	public long insert(JobInstanceSnapshot jobInstanceSnapshot)
		...
		Long result = null;
		try {
			result = (Long) sqlMapClients.getSqlMapClient().insert(
    ...
    @Override public JobInstanceSnapshot get(long id) throws AccessException {
        ...
        query.setId(id);
        return (JobInstanceSnapshot) sqlMapClients.getSqlMapClient().queryForObject("JobInstanceSnapshot.get", query);
    }
	...
	public JobInstanceSnapshot queryNewestInstance(long jobId)
        ...
        try {
			jobInstanceSnapshot = (JobInstanceSnapshot)sqlMapClients.getSqlMapClient().queryForObject("JobInstanceSnapshot.queryNewestInstance", query);
		} catch (Throwable e) {
	...
	public JobInstanceSnapshot queryInstanceGlobal(JobInstanceSnapshot query)
		...
		JobInstanceSnapshot jobInstanceSnapshot = null;
		try {
			jobInstanceSnapshot = (JobInstanceSnapshot)sqlMapClients.getSqlMapClient()
	...
	public int update(JobInstanceSnapshot jobInstanceSnapshot)
		...
		int result = 0;
		try {
			result = sqlMapClients.getSqlMapClient().update(
    ...
    @Override public boolean updateOffsetWithLock(long id, long offset, long originalVersion) throws AccessException {
        ...
        try {
            long count = sqlMapClients.getSqlMapClient().update("JobInstanceSnapshot.updateOffsetWithLock", queryMap);
            if (count < 1)
                return false;
            else
                return true;
    ...
    @Override public boolean setLockedWithCondition(long id, Date threshold, long offset) throws AccessException {
        ...
        try {
            long count = sqlMapClients.getSqlMapClient().update("JobInstanceSnapshot.setLockedWithCondition", queryMap);
            if (count < 1)
                return false;
            else
                return true;
	...
	public int delete(JobInstanceSnapshot jobInstanceSnapshot)
		...
		int result = 0;
		try {
			result = sqlMapClients.getSqlMapClient().delete(
	...
	public JobInstanceSnapshot findByJobIdAndFireTime(long jobId,
		...
		try {
			return (JobInstanceSnapshot) sqlMapClients.getSqlMapClient()
					.queryForObject(
