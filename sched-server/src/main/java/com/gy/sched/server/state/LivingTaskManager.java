//package com.letv.sched.server.state;
//
...
//import com.alibaba.dts.server.context.ServerContext;
//import com.alibaba.dts.server.monitor.callback.Display;
//import com.alibaba.dts.server.state.timer.PushTimer;
//import com.alibaba.dts.server.store.JobAccess;
//import com.alibaba.dts.server.store.JobInstanceSnapshotAccess;
//import com.alibaba.dts.server.store.ServerJobInstanceMappingAccess;
...
//	 * @return
//	 */
////	private AtomicInteger getCounter(Long key) {
////		AtomicInteger counter = counterMap.get(key);
////		if(null == counter) {
////			counter = new AtomicInteger(0);
////			AtomicInteger existCounter = counterMap.putIfAbsent(key, counter);
