...
public class JobInstanceSnapshot {
	...
	public String toString() {
		return "JobInstanceSnapshot [id=" + id + ", gmtCreate=" + gmtCreate
				...
				+ jobInstanceResult + ", offset=" + offset + ", lockVersion="
				+ lockVersion + ", retryCount=" + retryCount
				+ ", nextRetryTime=" + nextRetryTime + ", notifyVersion="
				+ notifyVersion + ", relationTag=" + relationTag
				+ ", resultVersion=" + resultVersion + ", isLocked=" + isLocked
				+ ", gmtLocked=" + gmtLocked + ", information=" + information
				+ "]";
	}
