...
import com.gy.sched.common.domain.remoting.ClassKey;
...
public class ProxyService implements Constants {
	 ...
	 * @return
	 */
	public <T> T cglibProxyInterface(Class<T> interfaceClass, ProxyInterface methodInterceptor) {
		return (T) methodInterceptor.getProxy(interfaceClass);
	}
