package com.gy.sched.client.config;
...
//		try {
//			this.version = "1.0.4.9-SNAPSHOT";//Manifests.read("App-Version");
//		} catch (Throwable e) {
...
//		}
		...
		this.zkHosts = "10.154.156.180:2181";
...
//	}
	...
	public String toString() {
		return "ClientConfig [remotingThreads=" + remotingThreads
				...
				+ ", connectionTimeout=" + connectionTimeout + ", appName="
				+ appName + ", zkHosts=" + zkHosts + ", namespace=" + namespace
