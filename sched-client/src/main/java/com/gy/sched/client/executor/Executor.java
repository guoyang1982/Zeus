package com.gy.sched.client.executor;

import com.gy.sched.client.context.ClientContext;
import com.gy.sched.client.executor.stop.StopJob;
...
import com.gy.sched.client.executor.simple.SimplePool;
...
import com.gy.sched.common.util.RandomUtil;
...
public class Executor implements ClientContext, Constants {
	...
	public void acknowledge(TaskSnapshot taskSnapshot, int status, int retryTimes) {
		...
		//如果clientId为空就补上
		if(StringUtils.isEmpty(taskSnapshot.getClientId())) {
